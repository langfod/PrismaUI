...
namespace PrismaUI::WebGL {
    ...
    template <typename T>
    JSTypedArrayType ExpectedTypedArrayType();
    template <>
    JSTypedArrayType ExpectedTypedArrayType<GLfloat>() {
        return kJSTypedArrayTypeFloat32Array;
    }
    template <>
    JSTypedArrayType ExpectedTypedArrayType<GLint>() {
        return kJSTypedArrayTypeInt32Array;
    }
    template <>
    JSTypedArrayType ExpectedTypedArrayType<GLuint>() {
...
#define UNIFORM_1(suffix, glFunc, castType)                                                            \
    JSValueRef GL_uniform1##suffix(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, \
                                   const JSValueRef argv[], JSValueRef*) {                             \
        auto* c = GetContext(thisObject);                                                              \
...
#undef UNIFORM_1
    ...
    JSValueRef GL_uniform2f(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, const JSValueRef argv[],
        ...
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform2f(loc, static_cast<GLfloat>(JSValueToNumber(ctx, argv[1], nullptr)),
    ...
    JSValueRef GL_uniform3f(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, const JSValueRef argv[],
        ...
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform3f(loc, static_cast<GLfloat>(JSValueToNumber(ctx, argv[1], nullptr)),
                    static_cast<GLfloat>(JSValueToNumber(ctx, argv[2], nullptr)),
    ...
    JSValueRef GL_uniform4f(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, const JSValueRef argv[],
        ...
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform4f(loc, static_cast<GLfloat>(JSValueToNumber(ctx, argv[1], nullptr)),
                    static_cast<GLfloat>(JSValueToNumber(ctx, argv[2], nullptr)),
                    static_cast<GLfloat>(JSValueToNumber(ctx, argv[3], nullptr)),
    ...
    JSValueRef GL_uniform2i(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, const JSValueRef argv[],
        ...
        if (!c || !c->initialized || argc < 3) return JSValueMakeUndefined(ctx);
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform2i(loc, static_cast<GLint>(JSValueToNumber(ctx, argv[1], nullptr)),
    ...
    JSValueRef GL_uniform3i(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, const JSValueRef argv[],
        ...
        if (!c || !c->initialized || argc < 4) return JSValueMakeUndefined(ctx);
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform3i(loc, static_cast<GLint>(JSValueToNumber(ctx, argv[1], nullptr)),
                    static_cast<GLint>(JSValueToNumber(ctx, argv[2], nullptr)),
    ...
    JSValueRef GL_uniform4i(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, const JSValueRef argv[],
        ...
        if (!c || !c->initialized || argc < 5) return JSValueMakeUndefined(ctx);
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform4i(loc, static_cast<GLint>(JSValueToNumber(ctx, argv[1], nullptr)),
                    static_cast<GLint>(JSValueToNumber(ctx, argv[2], nullptr)),
                    static_cast<GLint>(JSValueToNumber(ctx, argv[3], nullptr)),
    ...
    JSValueRef GL_vertexAttrib1f(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        auto* c = GetContext(thisObject);
        if (!c || !c->initialized || argc < 2) return JSValueMakeUndefined(ctx);
        glVertexAttrib1f(static_cast<GLuint>(JSValueToNumber(ctx, argv[0], nullptr)),
    ...
    JSValueRef GL_vertexAttrib2f(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        auto* c = GetContext(thisObject);
        if (!c || !c->initialized || argc < 3) return JSValueMakeUndefined(ctx);
        glVertexAttrib2f(static_cast<GLuint>(JSValueToNumber(ctx, argv[0], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[1], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[2], nullptr)));
        return JSValueMakeUndefined(ctx);
    }
    ...
    JSValueRef GL_vertexAttrib3f(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        auto* c = GetContext(thisObject);
        if (!c || !c->initialized || argc < 4) return JSValueMakeUndefined(ctx);
        glVertexAttrib3f(static_cast<GLuint>(JSValueToNumber(ctx, argv[0], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[1], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[2], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[3], nullptr)));
        return JSValueMakeUndefined(ctx);
    ...
    JSValueRef GL_vertexAttrib4f(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        auto* c = GetContext(thisObject);
        if (!c || !c->initialized || argc < 5) return JSValueMakeUndefined(ctx);
        glVertexAttrib4f(static_cast<GLuint>(JSValueToNumber(ctx, argv[0], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[1], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[2], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[3], nullptr)),
                         static_cast<GLfloat>(JSValueToNumber(ctx, argv[4], nullptr)));
    ...
    JSValueRef GL_uniform2ui(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        if (!c || !c->initialized || argc < 3) return JSValueMakeUndefined(ctx);
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform2ui(loc, static_cast<GLuint>(JSValueToNumber(ctx, argv[1], nullptr)),
    ...
    JSValueRef GL_uniform3ui(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        if (!c || !c->initialized || argc < 4) return JSValueMakeUndefined(ctx);
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform3ui(loc, static_cast<GLuint>(JSValueToNumber(ctx, argv[1], nullptr)),
                     static_cast<GLuint>(JSValueToNumber(ctx, argv[2], nullptr)),
    ...
    JSValueRef GL_uniform4ui(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        if (!c || !c->initialized || argc < 5) return JSValueMakeUndefined(ctx);
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));
        glUniform4ui(loc, static_cast<GLuint>(JSValueToNumber(ctx, argv[1], nullptr)),
                     static_cast<GLuint>(JSValueToNumber(ctx, argv[2], nullptr)),
                     static_cast<GLuint>(JSValueToNumber(ctx, argv[3], nullptr)),
...
#define UNIFORM_MAT_NONSQUARE(name, glFunc, divisor)                                                                  \
    JSValueRef GL_##name(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], \
                         JSValueRef*) {                                                                               \
        auto* c = GetContext(thisObject);                                                                             \
        if (!c || !c->initialized || argc < 3) return JSValueMakeUndefined(ctx);                                      \
        GLint loc = static_cast<GLint>(GetGLId(ctx, argv[0]));                                                        \
        ...
        const GLfloat* ptr;                                                                                           \
        size_t n = ExtractNumericArray(ctx, argv[2], tmp, kMaxTempFloats, &ptr);                                      \
        if (n >= divisor) glFunc(loc, static_cast<GLsizei>(n / divisor), transpose, ptr ? ptr : tmp);                 \
        return JSValueMakeUndefined(ctx);                                                                             \
    }
...
#undef UNIFORM_MAT_NONSQUARE
    ...
    JSValueRef GL_vertexAttribI4i(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        auto* c = GetContext(thisObject);
        if (!c || !c->initialized || argc < 5) return JSValueMakeUndefined(ctx);
        glVertexAttribI4i(static_cast<GLuint>(JSValueToNumber(ctx, argv[0], nullptr)),
    ...
    JSValueRef GL_vertexAttribI4ui(JSContextRef ctx, JSObjectRef, JSObjectRef thisObject, size_t argc,
        ...
        auto* c = GetContext(thisObject);
        if (!c || !c->initialized || argc < 5) return JSValueMakeUndefined(ctx);
        glVertexAttribI4ui(static_cast<GLuint>(JSValueToNumber(ctx, argv[0], nullptr)),
